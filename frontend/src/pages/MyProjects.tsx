...
const MyProjects = () => {
  ...
  const deleteProject = async (projectId: string) => {
    ...
    try {
      ...
      const confirm = window.confirm('Are you surer you want to delete this projects? ');
      ...
      {loading ? (
        ...
        <div className="py-10 min-h-[80vh]">
          ...
          <div className="flex items-center justify-between mb-12">
            ...
            <button onClick={() => navigate('/')} className="flex items-center gap-2 text-white px-3 sm:px-6 py-1 sm:py-2 rounded bg-linear-to-br  from-indigo-500 to-indigo-600 hover:opacity-90 active:sclae-95 transition-all ">
          ...
          <div className="flex flex-wrap gap-3.5">
            {projects.map((project) => (
              ...
              <div onClick={() => navigate(`/project/${project.id}`)} className="relative group w-72 max-sm:mx-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg overflow-hidden shadow-md group  hover:shadow-indigo-700/30 hover:border-indigo-800/80 transition-all duration-300 " key={project.id} >
        ...
        <div className="flex flex-col items-center justify-center h-[80vh]">
          ...
          <h1 className="text-3xl font-semibold text-gray-300">You have no propjects yet</h1>
