...
const Pricing = () => {
  ...
  const handlePurchase = async (planId: string) => {
    ...
    try {
      ...
      console.log(error , "please solve it ");
  ...
  return (
    <>
      ...
      <div className="w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]">
        ...
        <p className='mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light'>Project <span className='text-white'>Create / Resvision</span>consume  <span className='text-white'>5 credits </span>. You can purchase more credits to create more projects.</p>
